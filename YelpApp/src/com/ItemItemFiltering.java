	...
	public static void main(String args[]) 
	{
		 ...
		 for(YelpDataSet3 item : obj.list_alldata3 )		// line 43 in original code
		 {
			 ...
			 if (compare1 != null)
			 {
				 ...
				 System.out.println("================================ for compare1" );
				 ...
				 for (String eachKey: hashEntries.keySet())				 							// start comparing this object with others in the map
				 {
					 ...
					 System.out.println("rating before business  " + compare2.getRating_avg()  + "  for  " + compare2.businessid);
					 if (c2Reviews.size() > 0 )
					 {
						 compare2.setRating_avg((double)starSum/(double)c2Reviews.size());				// set the rating of this object in the map
					 }
					 System.out.println("rating after business  " + compare2.getRating_avg()  + "  for  " + compare2.businessid);
					 ...
					 if(!eachKey.equals(business_id))
					 {
						 ...
						 for (String eachReview: temp)
						 {
							 ...
							 System.out.println(part1  + " user " + eachReview);
							 System.out.println(part2  + " user " + eachReview);
						 ...
						 if ((drp1 >0.0)&&(drp2>0.0))
						 {
							 ...
							 System.out.println(" similar " + similarity  + "   " + eachKey);
				 ...
				 // similar business have +1 otherwise -1
				 for (HashObject eachKey: beforeSort)
				 {
					 System.out.println(" all business " + eachKey.getSimilarity());
